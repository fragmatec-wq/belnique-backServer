...
router.post('/:articleId/comment/:commentId/reply', blogController.replyComment);
router.post('/:articleId/comment/:commentId/reply/:replyId/like', blogController.likeReply);
