...
const { protectAdmin, superAdmin } = require('../middleware/adminAuthMiddleware');
...
router.delete('/admins/:id', protectAdmin, superAdmin, deleteAdmin);
router.put('/admins/:id/status', protectAdmin, superAdmin, updateAdminStatus);
router.post('/admins/:id/reset-password', protectAdmin, superAdmin, resetAdminPassword);
